...
/* 
 * This example shows how to use the Menu Library with your own LCD
...
"--START:105"
"--STOP:106";
Menu menu(menuItems); //Set up menu (Constructor)

/////////////////////////////////////////////////////////////////////////////////////////////THE LCD PART 2
//The routine that displays the menu on the LCD
void showMenu() {
  if (menu.needsUpdate()) {
    lcd.clear();
